			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-5 col-md-12">
						<div class="row">
							<h1><span data-translate="Buy_header1_1" ></span><span>The Sandbox</span><br /><span data-translate="Buy_header1_2"></span></h1>
					...
					<div class="col-lg-5 col-md-12">
					<img src="<?= get_template_directory_uri() ?>/img/buy_coins/coins/SAND.png" alt="flags" width="100%"/>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12" style="border-left:6px solid #6B47ED; margin-top:60px; margin-left:15px;">
						<h2>
							<span>How to Buy The Sandbox with</span>
						</h2>
						<h2>
					...
					<div class="col-lg-6 col-md-12">
						<div class="step-header">
							...
							<p>
								...
								<span>Choose the payment method best suits your needs to buy SAND.</span>
							</p>
						</div>
						<div class="step-header" style="padding-top:50px">
							...
							<p >
								<span>Once your account is funded, you will be able to buy SAND</span>
					...
					<div class="col-lg-6 col-md-12">
						...
						<div class="whyBuyBox">
							...
							<div class="innerBox" style="background-color: #E7A645;">
								...
								<p>We don’t charge you deposit or withdrawal fees. Enjoy FREE cash in and cash out! For crypto withdrawal fees, we cover network fees up to 6 CAD, which makes a lot of them also FREE! Take advantage of the cost-effective trading today. 
								</p>
							</div>
						</div>
						<div class="whyBuyBox">
		...
		<div id="learn-about" style="background-color: #F9F9F9; padding-bottom: 15px">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12" >
						<p id="introduction" data-translate="The Sandbox_intro" class="introSmall"></p>
				...
				<div class="row" style="margin-top:50px; margin-bottom:30px;">
					<div class="col-lg-12 col-md-12" >
						...
						<p>
							<span>Besides trading SAND, you can also purchase SAND</span>
