<div class="fingertips-item app-qr-parts">
	...
	<div class="row">
		<div id="stores" class="col-lg-5 col-md-5 app-store">
				...
				<a href="https://virgocx.oss-us-west-1.aliyuncs.com//prod/2021/07/23/25e6dedf49d6432dadc350414eea2128.apk"><img class="android_download" data-value="android" src="<?= get_template_directory_uri() ?>/img/app_buttons/android.png" alt="images not found" /></a>
		</div>
