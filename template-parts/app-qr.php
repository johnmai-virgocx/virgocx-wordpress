<div class="fingertips-item app-qr-parts">
	...
	<div class="row">
		<div id="stores" class="col-lg-5 col-md-5 app-store">
				...
				<a href="https://virgocx.s3.ca-central-1.amazonaws.com/prod/2021/12/30/861643257275474bbae73bc7a7cabe12.apk"><img class="android_download" data-value="android" src="<?= get_template_directory_uri() ?>/img/app_buttons/android.png" alt="images not found" /></a>
		</div>
