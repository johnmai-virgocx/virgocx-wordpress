			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-5 col-md-12">
						<div class="row">
							<h1><span data-translate="Buy_header1_1" ></span><span>TerraUSD</span><br /><span data-translate="Buy_header1_2"></span></h1>
					...
					<div class="col-lg-5 col-md-12">
					<img src="<?= get_template_directory_uri() ?>/img/buy_coins/coins/UST.png" alt="flags" width="100%"/>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
						...
						<p >
							<span>Sign up on VirgoCX website or mobile app. Simply provide the required basic information and pass our verification process quickly. Click </span>
					...
					<div class="col-lg-6 col-md-12">
						<div class="whyBuyBox">
							...
							<div class="innerBox" style="background-color: #6950D0;">
								...
								<p>
									<span>Buy and sell cryptocurrency like</span>
									<span>TerraUSD</span>
		...
		<div id="learn-about" style="background-color: #F9F9F9; padding-bottom: 15px">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12" >
						<p id="introduction" data-translate="TerraUSD_intro" class="introSmall"></p>
