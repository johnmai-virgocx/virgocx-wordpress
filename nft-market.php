...
foreach ($array as $rkey => $array){
  if ($array->trendingCollections == 1){
    $trendingRows[] = $array;
  }
}
get_header('otc');
...
<div class="nft-market-container">
  ...
  <ul class="search-list-container">
    ...
    <li>
      ...
      <a href="../en-nft-detail/?id=<?php echo base64_encode($row->id) ?>" target ="_blank">
  ...
  <div class="contact-container">
    ...
    <button class="contact-btn" data-translate="NFT_ContactUs"
      href="../en-otc-nft-brokerage/?#contact-form" target="_blank">Contact Us</button>
  </div>
                ...
                <div class="owl-stage-outer">
                  <div class="owl-stage">
                    ...
                    <div class="owl-item ">
                      ...
                      <a class="pg-top" href="<?php echo $row->collectionLink ?>" target ="_blank">
                        <div class="img-container">
                          <img src="<?php echo $row->thumbnail; ?>" alt="">
                        </div>
