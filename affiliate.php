            ...
            <div class="rmain-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <p>You can track the performance of each affiliate link you share. You will earn a 0.08%
                            commission on all trading amounts made by users who signed up using your link.</p>
                    </div>
                </div>
            </div>
        </div>
