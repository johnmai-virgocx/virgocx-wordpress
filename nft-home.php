...
?>
    <div class="nft-home-container">
        ...
        <div class="slider-container">
                                            ...
                                            <?php foreach ($rows as $row) { ?>
                                                <div class="owl-item ">
                                                    ...
                                                    <a class="pg-top">
                                                        ...
                                                        <img src="<?= get_template_directory_uri() ?>/img/nft-card-demo.jpg"
                                                             alt="">
                                                        <div class="content">
            ...
            <div class="action">
                <a class="view-more round-btn-light" data-translate="NFT_ViewMore" href="../en-nft-mkt/">View More</a>
            </div>
        </div>
                    ...
                    <div class="row custom-container">
                        <div class="icon-box">
                            ...
                            <img class="image" style="height: 348px"
                                 src="<?= get_template_directory_uri() ?>/img/nft/How_it_works_buying_an_NFT.svg"
                                 alt="">
                        </div>
                        <div class="num-box">
                            <p>1.</p>
                    ...
                    <div class="row custom-container">
                        <div class="icon-box">
                            <img class="image" style="height: 424px"
                                 src="<?= get_template_directory_uri() ?>/img/nft/How_it_works_Selling_your_NFT.svg"
                                 alt="">
        ...
        <section class="signup-area">
            <div class="background-img">
                <img src="<?= get_template_directory_uri() ?>/img/Sign Up Today/Background 2.svg"
                     alt="images not found">
                <img src="<?= get_template_directory_uri() ?>/img/Sign Up Today/Background 1.svg"
                     alt="images not found">
            </div>
            <div class="container custom-container">
