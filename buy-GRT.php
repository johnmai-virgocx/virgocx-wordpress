			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-5 col-md-12">
						<div class="row">
							<h1><span data-translate="Buy_header1_1" ></span><span>The Graph</span><br /><span data-translate="Buy_header1_2"></span></h1>
					...
					<div class="col-lg-5 col-md-12">
					<img src="<?= get_template_directory_uri() ?>/img/buy_coins/coins/GRT.png" alt="flags" width="100%"/>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-6 col-md-12">
						<div class="step-header">
							...
							<p>
								...
								<span data-translate="Buy_header11_desc3_needs"></span>
							</p>
						</div>
		...
		<div id="learn-about" style="background-color: #F9F9F9; padding-bottom: 15px">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12" >
						<p id="introduction" data-translate="The Graph_intro" class="introSmall"></p>
				...
				<div class="row" style="margin-top:90px; margin-bottom:50px;">
					<div class="col-lg-12 col-md-12" >
						<h2>
							<span>How to Purchase GRT in Canada </span>
							<div style="background-color:#D4CCF7; height: 18px; margin-top:-20px;"></div>
						</h2>
				...
				<div class="row" style="margin-top:90px; margin-bottom:60px;">
					<div class="col-lg-12 col-md-12" >
						...
						<p style="margin-bottom:90px;">You can also buy and sell Bitcoin, Ethereum, Bitcoin Cash, Litecoin, and other cryptocurrencies using your debit or credit cards on a cryptocurrency ATM.  However, it’s subject to high fees and your options are limited to a few select coins.  Depending on how much crypto you want to buy, you also need to take into account its daily trading limit and per transaction limit. </p>
						<h2>
							<span>How Can I Use My GRT?</span>
							<div style="background-color:#D4CCF7; height: 18px; margin-top:-20px;"></div>
						</h2>
					</div>
				</div>
				...
				<div class="row" style="margin-top:50px; margin-bottom:30px;">
					<div class="col-lg-12 col-md-12" >
						...
						<p>
							<span>You can either trade GRT or buy GRT</span>
